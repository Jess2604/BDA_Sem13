...
#Creamos dos tablas donde insertamos los valores, en este caso será Asistencias y Faltas
...
#Aquí las correlacionamos ambas columnas para que nos muestré un valor entre -1 y 1, donde lo más
# optimo es que sea más de 0.5
